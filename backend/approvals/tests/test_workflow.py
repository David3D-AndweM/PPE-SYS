...
class TestApprovalWorkflow:
    def test_manager_can_approve_manager_approval(self, manager_client, manager_approval):
    ...
    def test_reject_propagates_to_slip(self, manager_client, manager_approval):
        resp = manager_client.post(
